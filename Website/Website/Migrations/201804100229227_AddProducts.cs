namespace Website.Migrations
{
    ...
    public partial class AddProducts : DbMigration
    {
        ...
        {
            Sql(@"INSERT INTO [dbo].[Products] ([Name], [Price], [ImageLink], [Size], [CategoryId], [NumberInStock], [Viewable]) VALUES (N'Gildan Men''s Classic T-Shirt', CAST(19.99 AS Decimal(18, 2)), N'https://i.imgur.com/WdFVNkT.png', N'Small', 1, 20, 0)                  
